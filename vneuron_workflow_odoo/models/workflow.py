...
class Workflow(models.Model):
    ...
    @api.multi
    def write(self, vals):
        odoo.addons.vneuron_workflow_odoo.workflow .clear_cache(self._cr, self._uid)
...
class WorkflowActivity(models.Model):
    ...
    name = fields.Char('Name', required=True)
    code = fields.Char('Code(code of state)', required=True)
    ordre = fields.Integer('Order(order of state)', required=True)
