...
class ReportController(report.ReportController):
    ...
    def report_routes(self, reportname, docids=None, converter=None, **data):
        _logger.info('-------mrissa ReportController report_routes-----%s : ',reportname)
        _logger.info('-------mrissa ReportController docids-----%s : ',docids)
        if converter == 'jasper':
            ...
            _logger.info('-------mrissa ReportController report_jas-----%s : ',report_jas)
            _logger.info('-------mrissa ReportController context-----%s : ',context)
            if docids:
        ...
        _logger.info('-------mrissa ReportController return  docids-----%s : ',docids)
        _logger.info('-------mrissa ReportController return  converter-----%s : ',converter)
        _logger.info('-------mrissa ReportController return  **data-----%s : ',**data)
