...
class Report:
    def __init__(self, name, cr, uid, ids, data, context):
        ...
        _logger.info('----Mrissa Report  name-----%s : ',name)
        _logger.info('----Mrissa Report data end-----%s : ',data['env'])
        _logger.info('----Mrissa Report cr-----%s : ',cr)
        _logger.info('----Mrissa Report ids-----%s : ',ids)
        _logger.info('----Mrissa Report data-----%s : ',data)
        _logger.info('----Mrissa Report self.model-----%s : ',self.model)
    ...
    def execute(self):
        ...
        _logger.info('----Mrissa Report rep_xml_set-----%s : ',rep_xml_set)
        _logger.info('----Mrissa Report data-----%s : ',data)
        ...
        _logger.info('----Mrissa Report  data_file-----%s : ',data_file)
        _logger.info('----Mrissa Report  output_file-----%s : ',output_file)
        _logger.info('----Mrissa Report  sub_report_data_files-----%s : ',sub_report_data_files)
        _logger.info('----Mrissa Report  self.data   -----%s : ',self.data )
    ...
    def execute_report(self, data_file, output_file, sub_report_data_files):
        ...
        _logger.info('----Mrissa Report execute_report data_file-----%s : ',data_file)
        _logger.info('----Mrissa Report execute_report output_file-----%s : ',output_file)
        _logger.info('----Mrissa Report execute_report sub_report_data_files-----%s : ',sub_report_data_files)
        _logger.info('----Mrissa Report execute_report connection_parameters-----%s : ',connection_parameters)
        ...
        _logger.info('----Mrissa Report execute_report parameters-----%s : ',parameters)
        if 'parameters' in self.data:
            parameters.update(json.loads(self.data.get('parameters')))
            _logger.info('----Mrissa Report execute_report parameters2-----%s : ',parameters)
