...
class CsvRecordDataGenerator(AbstractDataGenerator):
    ...
    def __init__(self, report, records):
        self.report = report
        _logger.info('-------mrissa CsvRecordDataGenerator   records-----%s : ',records)
        _logger.info('-------mrissa CsvRecordDataGenerator   report-----%s : ',report)
    ...
    def generate(self, file_name):
        ...
        with open(file_name, 'wb+') as f:
            ...
            for record in self.records:
                ...
                _logger.info('-------mrissa CsvRecordDataGenerator   writer.writerow(row)-----%s : ',row)
                writer.writerow(row)
...
class XmlRecordDataGenerator(AbstractDataGenerator):
    ...
    # the parser function.
    def generate(self, file_name):
        _logger.info('-------mrissa XmlRecordDataGenerator  generate)-----%s : ',file_name)
